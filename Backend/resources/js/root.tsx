...
export default function Root() {
  ...
  useEffect(() => {
    ...
    fetch('http://localhost/MeinProfil', {
      credentials: 'include',
      headers: {
      ...
      <div className="searchbar-wrapper relative flex items-center gap-2">
        ...
        {open && (
          <input
            ...
            className="searchbar w-full pl-3 pr-3 py-2 rounded border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 focus:outline-none"
          />
        )}

        {open && results.length > 0 && (
          <div className="searchbar absolute left-0 top-full mt-2 z-30 w-64 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded shadow overflow-hidden">
            {results.map(item => {
              ...
              return (
                <a
                  ...
                  className="flex items-center gap-3 p-2 hover:bg-zinc-50 dark:hover:bg-zinc-800/50"
                >
                ...
                <span className="flex min-w-0 items-center gap-3">
                  ...
                  <span className="min-w-0">
                    ...
                    <span className="block truncate text-xs/5 font-normal text-zinc-500 dark:text-zinc-400">
                      {user?.username || 'erica@example.com'}
                    </span>
                  </span>
                </span>
                <ChevronUpIcon />
